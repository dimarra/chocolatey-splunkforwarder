...
$local_url = 'https://ip-172-31-25-24.ap-southeast-2.compute.internal/splunk'
$url =   "$local_url/$packageName-$version-$suffix-x86-release.msi"
$url64 = "$local_url/$packageName-$version-$suffix-x64-release.msi"
